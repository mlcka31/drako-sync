export const contractAddress =
  (process.env.PUBLIC_NEXT_SMART_CONTRACT_ADDRESS as `0x${string}`) ||
...
export const backendAttestation =
  (process.env.PUBLIC_NEXT_BACKEND_ATTESTATION_URL as `0x${string}`) ||
  "https://github.com/mlcka31/zk-dungeon-backend";

export const backendApp =
  (process.env.PUBLIC_NEXT_BACKEND_APP_URL as `0x${string}`) ||
  "https://github.com/mlcka31/zk-dungeon-backend";
